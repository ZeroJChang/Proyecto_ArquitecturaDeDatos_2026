...
- Backup/restore procedures in [Operations Guide](../../operations/operations-guide.md) reference provider tooling (Supabase PITR, Atlas continuous backup).
- RTO/RPO targets in [High-Level Design](../../hld.md) assume managed-service guarantees.
