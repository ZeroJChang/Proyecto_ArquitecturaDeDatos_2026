...
| Name | Type | Purpose | Link |
|------|------|---------|------|
| Decision Index | ADR index | Entry point to all architectural decisions of record | [`decision-index.md`](decision-index.md) |
| High-Level Design | Design doc | System vision, C4 diagrams, scalability and recovery posture | [`hld.md`](hld.md) |

## Operations
| Name | Type | Purpose | Link |
|------|------|---------|------|
| Operations Guide | Runbooks | Symptom-to-runbook for ingestion stalls, DB outages, backlog | [`operations-guide.md`](operations-guide.md) |
| Observability | Signals | Logs, metrics, and health assessment for the platform | [`observability.md`](observability.md) |
