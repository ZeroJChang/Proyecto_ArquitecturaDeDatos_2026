...
- The producer is the sole writer; Spark is the sole consumer ([`integration-map.md`](../integration-map.md)).
...
For production scale, move to 3 brokers with replication factor 3 and 6–9 partitions per topic (see scaling plan in [`hld.md`](../hld.md)). Reassess partition count as the fleet grows toward the 5-year projection.
